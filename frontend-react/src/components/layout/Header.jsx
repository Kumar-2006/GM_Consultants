      ...
      <div className="site-header__inner container">
        <div className="site-header__brand">
          <NavLink to="/" aria-label="GM Consultants home">
            <img src={Logo} alt="GM Consultants" className="site-header__logo" />
        ...
        <nav className={clsx('site-nav', { 'site-nav--open': menuOpen })}>
          {navLinks.map((item) => (
            <NavLink
              ...
              className={({ isActive }) => clsx('site-nav__link', { 'site-nav__link--active': isActive })}
              onClick={() => setMenuOpen(false)}
            >
              <span>{item.label}</span>
            </NavLink>
          ))}
          <NavLink to="/consultation" className="site-nav__cta" onClick={() => setMenuOpen(false)}>
